...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_skills_category" AS ENUM('analysis', 'integration', 'data', 'modeling', 'testing', 'tool');
  CREATE TYPE "public"."enum_projects_blocks_artifact_artifact_type" AS ENUM('architecture', 'api', 'process', 'data', 'prototype', 'testing');
  CREATE TYPE "public"."enum_projects_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__projects_v_blocks_artifact_artifact_type" AS ENUM('architecture', 'api', 'process', 'data', 'prototype', 'testing');
  ...
  CREATE TABLE "projects_blocks_artifact" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"artifact_type" "enum_projects_blocks_artifact_artifact_type",
  	"external_url" varchar,
  	"file_id" integer,
  	"block_name" varchar
  );
  
  CREATE TABLE "projects_blocks_artifact_locales" (
  	"title" varchar,
  	"description" varchar,
  	"code" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "projects_locales" (
  	...
  	"case_study_solution" varchar,
  	"case_study_role" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  ...
  CREATE TABLE "_projects_v_blocks_artifact" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"artifact_type" "enum__projects_v_blocks_artifact_artifact_type",
  	"external_url" varchar,
  	"file_id" integer,
  	"_uuid" varchar,
  	"block_name" varchar
  ...
  CREATE TABLE "_projects_v_blocks_artifact_locales" (
  	"title" varchar,
  	"description" varchar,
  	"code" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_projects_v" (
  	...
  	"version_accent" varchar DEFAULT '#6ee7b7',
  	"version_featured" boolean DEFAULT false,
  	"version_is_demo" boolean DEFAULT true,
  ...
  CREATE TABLE "_projects_v_locales" (
  	...
  	"version_case_study_solution" varchar,
  	"version_case_study_role" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  ...
  ALTER TABLE "projects_blocks_artifact" ADD CONSTRAINT "projects_blocks_artifact_file_id_media_id_fk" FOREIGN KEY ("file_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "projects_blocks_artifact" ADD CONSTRAINT "projects_blocks_artifact_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "projects_blocks_artifact_locales" ADD CONSTRAINT "projects_blocks_artifact_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."projects_blocks_artifact"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_projects_v_blocks_artifact" ADD CONSTRAINT "_projects_v_blocks_artifact_file_id_media_id_fk" FOREIGN KEY ("file_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_projects_v_blocks_artifact" ADD CONSTRAINT "_projects_v_blocks_artifact_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_projects_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_projects_v_blocks_artifact_locales" ADD CONSTRAINT "_projects_v_blocks_artifact_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_projects_v_blocks_artifact"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "projects_blocks_artifact_order_idx" ON "projects_blocks_artifact" USING btree ("_order");
  CREATE INDEX "projects_blocks_artifact_parent_id_idx" ON "projects_blocks_artifact" USING btree ("_parent_id");
  CREATE INDEX "projects_blocks_artifact_path_idx" ON "projects_blocks_artifact" USING btree ("_path");
  CREATE INDEX "projects_blocks_artifact_file_idx" ON "projects_blocks_artifact" USING btree ("file_id");
  CREATE UNIQUE INDEX "projects_blocks_artifact_locales_locale_parent_id_unique" ON "projects_blocks_artifact_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX "_projects_v_blocks_artifact_order_idx" ON "_projects_v_blocks_artifact" USING btree ("_order");
  CREATE INDEX "_projects_v_blocks_artifact_parent_id_idx" ON "_projects_v_blocks_artifact" USING btree ("_parent_id");
  CREATE INDEX "_projects_v_blocks_artifact_path_idx" ON "_projects_v_blocks_artifact" USING btree ("_path");
  CREATE INDEX "_projects_v_blocks_artifact_file_idx" ON "_projects_v_blocks_artifact" USING btree ("file_id");
  CREATE UNIQUE INDEX "_projects_v_blocks_artifact_locales_locale_parent_id_unique" ON "_projects_v_blocks_artifact_locales" USING btree ("_locale","_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "projects_blocks_artifact" CASCADE;
  DROP TABLE "projects_blocks_artifact_locales" CASCADE;
  DROP TABLE "projects" CASCADE;
  DROP TABLE "projects_locales" CASCADE;
  DROP TABLE "projects_rels" CASCADE;
  DROP TABLE "_projects_v_blocks_artifact" CASCADE;
  DROP TABLE "_projects_v_blocks_artifact_locales" CASCADE;
  ...
  DROP TYPE "public"."enum_projects_blocks_artifact_artifact_type";
  DROP TYPE "public"."enum_projects_status";
  DROP TYPE "public"."enum__projects_v_blocks_artifact_artifact_type";
